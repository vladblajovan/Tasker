...
void main() {
  ...
  group('SearchTasks', () {
    test('should delegate to repository searchTasks with trimmed query',
        () async {
      when(() => mockTaskRepository.searchTasks('buy'))
          .thenAnswer((_) async => [
                Task(
                  id: '1',
                  title: 'Buy Groceries',
    ...
    test('should trim whitespace from query before delegating', () async {
      when(() => mockTaskRepository.searchTasks('clean'))
          .thenAnswer((_) async => [
                Task(
                  id: '2',
                  title: 'Clean House',
    ...
    test('should return empty list and not call repository for empty query',
        () async {
    ...
    test('should return empty list when repository finds no matches', () async {
      when(() => mockTaskRepository.searchTasks('xyz'))
          .thenAnswer((_) async => []);
    ...
    test('should return all matching tasks from repository', () async {
      ...
      when(() => mockTaskRepository.searchTasks('read'))
