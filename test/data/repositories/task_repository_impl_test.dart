...
void main() {
  ...
  group('getTaskById', () {
    ...
    test('should return null when not found', () async {
      when(() => mockDatasource.getTaskById('1')).thenAnswer((_) async => null);
  ...
  group('createTask', () {
    test(
      'should create task via datasource using fromEntity mapping',
      () async {
  ...
  group('updateTask', () {
    test(
      'should update task via datasource using fromEntity mapping',
      () async {
  ...
  group('searchTasks', () {
    test(
      'should return tasks matching the query in title or description',
      () async {
